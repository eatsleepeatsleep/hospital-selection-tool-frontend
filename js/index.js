...
function initMap() {
    ...
    document.querySelector('form').addEventListener('submit', function (event) {
        ...
        const isValid = validateForm(facialScoreValue, armScoreValue, speechScoreValue, onsetTimeValue, locationValue);
        if (!isValid) return;
        ...
        fetch('https://risk-averse-website-8cb20a6e9bc6.herokuapp.com/calculate', {
            method: 'POST',
            headers: {
